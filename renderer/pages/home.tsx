...
import createAccount from "../../main/accounts/create";
...
const Home: NextPage = () => {
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    const res = createAccount(mailServerData);
        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-background text-center">
          <a className="bg-white-border z-10 block max-w-sm rounded-lg border-gray-200 bg-white p-6 shadow dark:border-gray-700">
            ...
            <p className="mt-4 pb-5 font-normal text-gray-700 dark:text-gray-400">
              You can add more accounts after you have set everything up.
            </p>
            ...
            >
              ...
              <span className="mx-auto">Sign in with Microsoft</span>
            </button>
            <br></br>
            <button
              type="button"
